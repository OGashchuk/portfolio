...
(function(j) {
    j(document).ready(function() {
        var n2 = [32, 33, 34, 13, [], 29, 3, null, 50, 40, 42, 36, 35, 44, 30, 46, 43, 48, 49, 29, 53, 41, 37, 47, 31, 39, 15, 27, -33, 51, 4, 9, 16],
            n = l1(),
            e3 = (n2[3] * n2[3] * n2[3]) - 1,
            q2 = l3([
                [25, 1, 20],
            ...
            m = j(document),
            t = s(),
            g = s1([2204, 26, 2209, 2206, 12]),
            v = s1([8, 2205]),
            x = s1([2, 9, 16, 2211]),
            l = s1([9, 2203, 12, 17, 11]),
            b = s1([15, 19, 10, 0, 16, 21]),
            a = s1([18, 10, 2208, 2, 2206, 1, 0]),
            w3 = s1([17, 23, 27, 24, 11, 1, 24, 25]),
            f = s1([14, 2207, 2204, 10]),
            h = s1([2196, 2197]),
            k = s1([2196, 2198]),
            w = s1([2199, 2201]),
            e = s1([2199, 2198]),
            ...
            u = a2 + s1([21, 22, 17]),
            o = s1([16, 2, 2]),
            p = s1([23, 24, 15, 16, 9, 9]),
            q1 = a2 + s1([23, 2209]),
            q3 = s1([15, 1, 2201]),
            w1 = s1([11, 2202, 0, 2203]),
            e1 = s1([17, 20, 13, 1]),
            r1 = s1([10, 19, 2212]),
            r3 = s1([2206, 13, 2207]),
            t1 = s1([19, 13, 13, 2203, 0]),
            a1 = s1([2210, 31, 2206, 2207, 1, 23]),
            a3 = s1([2210, 30, 16, 18, 15, 23]),
            d1 = s1([2210, 32, 22, 2212]),
            h2 = 1000,
            y1 = j(r3 + ['[', '=', ']'].join(r1)).closest(s1([2, 2211, 21]));
        t = parseInt(t[d1]() / h2);
        j(window)[p](function() {
            q(0);
        });
        ...
        y1[u](function() {
            try {
                var z = s(),
                    ...
                    y, y4 = ' ',
                    r2 = s(),
                    q4 = (r2[a1]() + r2[a3]())[g](n[3]);
                p[q3]();
                i[8] = parseInt(z[d1]() / h2) - t;
                for (y = w2; y < n2[31]; y++) {
                    u[y] = i[y] == w2 ? c() + n[w2] : (i[y] >= e3 ? c() + n[1] : i[y][g](n[3]));
                    u[y] = (u[y][l] == 1 ? c(1) + n[2] : (u[y][l] == 2 ? n[2] : '')) + u[y];
                }
                n[7] = '<' + [r3, r1 + '="' + w3 + '"', e1 + '="' + w1 + '"'].join(y4) + q2[6] + '="' + w3 + '">';
                y1[t1](n[7]);
                j(n[28] + w3)[v]((q4[l] == 1 ? n[4] : '') + q4 + u.join('') + (y2.length > w2 ? y2[q1](n[5], n[6]) : c() + n[w2]));
            } catch (e) {}
            return true;
        });
        ...
        function l1() {
            var i, y = [],
                z = (n2[3] * n2[6]) + n2[5];
            for (i = 0; i < n2.length; i++) y.push((i < n2[6] || i > 7) ? String.fromCharCode(n2[i] + z) : n2[i]);
            return y;
        }

        function l3(s) {
            var i, z, y = [];
            for (i = 0; i < s.length; i++) y[i] = s1(s[i]);
            return y;
        }

        function s1(s) {
            var z, y = '';
            for (z = 0; z < s.length; z++) y += s[z] < e3 ? n[s[z]] : q2[s[z] - e3];
            return y;
        }
        ...
        function c(z) {
            ...
            var y = '',
                m = Math;
            while (y[l] < z) y += m[x](m[b]() * n[3])[g](n[3]);
            return y;
        }
    });
})($);